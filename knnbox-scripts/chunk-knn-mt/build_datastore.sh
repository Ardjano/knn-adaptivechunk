:<<!
[script description]: build a datastore for chunk-knn-mt
[dataset]: multi domain DE-EN dataset
[base model]: WMT19 DE-EN transformer
!
...
# Choose a path specific to the chunked datastore
DATASTORE_SAVE_PATH=$PROJECT_PATH/datastore/chunk/it
