...
@register_model("vanilla_knn_mt_visual")
class VanillaKNNMTVisual(TransformerModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--knn-mode", choices= ["build_datastore", "inference", "existing_datastore"],
    ...
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        ...
        """
        return VanillaKNNMTVisualDecoder(
            args,
            tgt_dict,
            embed_tokens,
...
"""
@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer")
def base_architecture(args):
    archs.base_architecture(args)

@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer_iwslt_de_en")
def transformer_iwslt_de_en(args):
    archs.transformer_iwslt_de_en(args)

@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer_wmt_en_de")
def transformer_wmt_en_de(args):
    archs.base_architecture(args)

# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer_vaswani_wmt_en_de_big")
def transformer_vaswani_wmt_en_de_big(args):
    archs.transformer_vaswani_wmt_en_de_big(args)

@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer_vaswani_wmt_en_fr_big")
def transformer_vaswani_wmt_en_fr_big(args):
    archs.transformer_vaswani_wmt_en_fr_big(args)

@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer_wmt_en_de_big")
def transformer_wmt_en_de_big(args):
    archs.transformer_vaswani_wmt_en_de_big(args)

# default parameters used in tensor2tensor implementation
@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer_wmt_en_de_big_t2t")
def transformer_wmt_en_de_big_t2t(args):
    archs.transformer_wmt_en_de_big_t2t(args)

@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer_wmt19_de_en")
def transformer_wmt19_de_en(args):
    archs.transformer_wmt19_de_en(args)

@register_model_architecture("vanilla_knn_mt_visual", "vanilla_knn_mt_visual@transformer_zh_en")
